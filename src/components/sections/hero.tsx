    ...
    <div className="relative overflow-hidden bg-background">
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col justify-center px-6 py-16 md:px-16 md:py-20">
          <div className="meta-text mb-7 flex items-center gap-3 text-[11px] font-medium tracking-[0.12em] text-muted-foreground uppercase">
          ...
          <div className="mb-12 flex flex-wrap items-center gap-4">
            <a
              href="#get-key"
              className="rounded-md bg-primary px-7 py-3.5 text-[0.9375rem] font-semibold text-primary-foreground transition-opacity hover:opacity-85"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="group flex items-center gap-2 text-[0.9375rem] font-medium text-muted-foreground hover:text-foreground"
            >
              Watch 2-minute demo
        ...
        <div className="relative hidden min-h-[calc(100vh-104px)] border-l border-border bg-[#0a0c10] md:block">
          <Image src="/chainn.webp" alt="" fill className="object-cover opacity-[0.06] mix-blend-luminosity" />
